...
- **FAQ/review source-of-truth hardening is LOCAL VERIFIED, NOT RELEASED
  (2026-08-09).** Canonical sources are `data/faq.json`, `data/reviews.json`, and
  ...
  49-item/98-open browser FAQ checks pass; rollout remains pending.
